...
import com.andking.chatty.adapter.ChatListAdapter;
import com.andking.chatty.custom.BaseActivity;
import com.andking.chatty.model.Conversation;
import com.andking.chatty.utils.Const;
		...
		query.findInBackground(new FindCallback<ParseObject>() {
			...
			public void done(List<ParseObject> li, ParseException e) {
				if (li != null && li.size() > 0) {
					Log.d("and_king", "li size" + li.size());
					for (int i = li.size() - 1; i >= 0; i--) {
						...
						Log.d("and_king", "li size" + po.getString("message") + " " + po.getString("sender") + "");
